...
#        return await app.leave_chat(chat_id)  
        ...
        for administrator in administrators:
            if administrator == message.from_user.id:
                ...
                try:
                    ...
                    await lel.edit(
                        f"<b>🛑 Flood Wait Error 🛑</b> \n\Hey @lelouchvc_assistant, assistant userbot couldn't join your group due to heavy join requests. Make sure userbot is not banned in group and try again later!"
                    )
    try:
    ...
    if audio:
        ...
        mystic = await message.reply_text(f"**🔄 Server is facing issues wait {username}**")
        ...
        link = "https://t.me/lelouchsupportchat"
        thumb = "cache/Lightblue.png"
        videoid = "smex1"
    elif url:
        what = "URL Searched"
        await LOG_CHAT(message, what)
